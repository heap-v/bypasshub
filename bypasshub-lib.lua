...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("BypassHubSettings.json") then
			writefile("BypassHubSettings.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("BypassHubSettings.json"))
	...
	options = self:set_defaults({
		...
		Link = "https://github.com/heap-v/bypasshub"
	}, options)

	if getgenv and getgenv().BypassHubUI then
		getgenv():BypassHubUI()
		getgenv().BypassHubUI = nil
	end
	...
	creditsTab:credit{Name = "heap", Description = "Founder + Scripter", Discord = "heap#8888", Roblox = "0heap"}
	creditsTab:credit{Name = "JohnKevinStr", Description = "Helper", Discord = "JohnKevinStr#6907", Roblox = "josephseetd9"}
	creditsTab:credit{Name = "Offical Discord", Description = "Discord Server", Server="https://discord.gg/tUNgC7eG6W"}
